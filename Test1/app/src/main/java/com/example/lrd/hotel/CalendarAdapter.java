...
import com.example.lrd.hotel.view.CustomCalendarTextView;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if(holder instanceof DayViewHolder){
            ...
            if(item.getState()==HotelDayBean.STATE_PAST) {
                ((DayViewHolder) holder).day.setTextColor(resources.getColor(R.color.gray));
                ...
                ((DayViewHolder) holder).day.setTextColor(resources.getColor(R.color.forestgreen));
            }
